 ...
 */
/* mtmt #define XTAL 4000000 */              /**< clock frequency in Hz, used to calculate delay timer */
/* mtmt #define XTAL 1000000 */              /**< clock frequency in Hz, used to calculate delay timer */
#ifndef F_CPU
#warning F_CPU not defined using 1MHz default
#define XTAL 1000000
#else
#define XTAL F_CPU
#endif
